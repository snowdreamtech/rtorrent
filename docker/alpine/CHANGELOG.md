...
## [0.16.12](https://github.com/snowdreamtech/rtorrent/compare/alpine-v0.16.12...alpine-v0.16.12) (2026-08-13)


### 🐛 Bug Fixes

* remove static version defaults from OCI image labels to use variable injection exclusively ([da5645a](https://github.com/snowdreamtech/rtorrent/commit/da5645ad4d48467290235abbbd9f31ba70bf690f))


### ♻️ Miscellaneous Chores

* add 0-git-keep.sh to prevent empty entrypoint.d directories ([ce77247](https://github.com/snowdreamtech/rtorrent/commit/ce77247762becc1edf85ec7b57747d3f3127044a))
* release main ([5a92edb](https://github.com/snowdreamtech/rtorrent/commit/5a92edb4ba76b04ee6de7369e9471f785849a7ae))
* release main ([afa286c](https://github.com/snowdreamtech/rtorrent/commit/afa286c5b9c41908021b044f31fee3348f52c973))
* release main ([4011a21](https://github.com/snowdreamtech/rtorrent/commit/4011a21a23395acc9545168c95ca0ec5c867e7d3))
* **release:** deduplicate CHANGELOG headers ([c2bba24](https://github.com/snowdreamtech/rtorrent/commit/c2bba247dca89a31accc6e70c5e48b16170b1ce5))
* **release:** deduplicate CHANGELOG headers ([4f07b71](https://github.com/snowdreamtech/rtorrent/commit/4f07b71194f58ba214f1fb60ce0dc56d71c499e2))
* update alpine base image to 3.24.1 ([3021ed3](https://github.com/snowdreamtech/rtorrent/commit/3021ed3b4ffa5f8916f5fa46aa4325e8ebf84ba6))

## [0.16.12](https://github.com/snowdreamtech/rtorrent/compare/alpine-v0.16.12...alpine-v0.16.12) (2026-06-29)
...
* **alpine:** add empty line to trigger release pipeline test ([6f32fb1](https://github.com/snowdreamtech/rtorrent/commit/6f32fb1c9fae9bcd4e86beb2e3013a0138784372))
* **alpine:** update rtorrent version to 0.16.12-r0 for alpine 3.24 ([a2a5a0e](https://github.com/snowdreamtech/rtorrent/commit/a2a5a0eecf1866e0030011458556d93023a425fa))
...
* resolve flood-alpine base image tag and disable rocky variant ([ca5e9f6](https://github.com/snowdreamtech/rtorrent/commit/ca5e9f6a764cd4b4cc1a5d1eeb6aa1633e4a73f8))
...
* update alpine node image tag to 24.16.0-alpine ([49958da](https://github.com/snowdreamtech/rtorrent/commit/49958da749eeea2ae7f4e0109f94192a9372025a))
